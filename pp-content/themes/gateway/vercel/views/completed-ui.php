...
<head>
    ...
    <style>
        :root {
            --stripe-blue: <?php echo $setting['response'][0]['primary_button_color']?>;
            --stripe-blue-dark: <?php echo $setting['response'][0]['button_hover_color']?>;
            --stripe-text: #1a1a1a;
                    ...
                    <div class="printer-paper-out">
                        <div class="receipt">
                            ...
                            <div class="receipt-row receipt-total">
                                ...
                                <span class="receipt-value" style="color: var(--stripe-success);">Completed</span>
                            </div>
                        </div>
                    </div>
                </div>
