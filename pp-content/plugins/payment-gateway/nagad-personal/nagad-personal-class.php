<?php
$plugin_meta = [
    'Plugin Name'       => 'Nagad Personal',
    'Description'       => 'Accept Nagad Personal payments directly from customers. Perfect for freelancers and small businesses.',
    'Version'           => '1.0.0',
    'Author'            => 'PipraPay',
...
function nagad_personal_admin_page() {
...
function nagad_personal_checkout_page($payment_id) {
