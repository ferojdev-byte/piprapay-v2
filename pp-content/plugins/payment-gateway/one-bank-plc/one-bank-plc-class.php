<?php
$plugin_meta = [
    'Plugin Name'       => 'ONE Bank PLC',
    'Description'       => 'Accept ONE Bank PLC payments directly from customers. Perfect for freelancers and small businesses.',
    'Version'           => '1.0.0',
    'Author'            => 'PipraPay',
...
function one_bank_plc_admin_page() {
...
function one_bank_plc_checkout_page($payment_id) {
