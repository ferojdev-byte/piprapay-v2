<?php
$plugin_meta = [
    'Plugin Name'       => 'Upay merchant',
    'Description'       => 'Accept Upay merchant payments directly from customers. Perfect for freelancers and small businesses.',
    'Version'           => '1.0.0',
    'Author'            => 'PipraPay',
...
function upay_merchant_admin_page() {
...
function upay_merchant_checkout_page($payment_id) {
