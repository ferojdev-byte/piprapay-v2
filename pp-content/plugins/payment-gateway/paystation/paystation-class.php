<?php
$plugin_meta = [
    'Plugin Name'       => 'PayStation',
    'Description'       => 'Accept PayStation payments directly from customers. Perfect for freelancers and small businesses.',
    'Version'           => '1.0.0',
    'Author'            => 'PipraPay',
...
function paystation_admin_page() {
...
function paystation_checkout_page($payment_id) {
