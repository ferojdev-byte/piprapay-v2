<?php
$plugin_meta = [
    'Plugin Name'       => 'Jamuna Bank PLC',
    'Description'       => 'Accept Jamuna Bank PLC payments directly from customers. Perfect for freelancers and small businesses.',
    'Version'           => '1.0.0',
    'Author'            => 'PipraPay',
...
function jamuna_bank_plc_admin_page() {
...
function jamuna_bank_plc_checkout_page($payment_id) {
