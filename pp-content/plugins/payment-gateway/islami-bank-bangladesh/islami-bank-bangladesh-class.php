<?php
$plugin_meta = [
    'Plugin Name'       => 'Islami Bank Bangladesh',
    'Description'       => 'Accept Islami Bank Bangladesh payments directly from customers. Perfect for freelancers and small businesses.',
    'Version'           => '1.0.0',
    'Author'            => 'PipraPay',
...
function islami_bank_bangladesh_admin_page() {
...
function islami_bank_bangladesh_checkout_page($payment_id) {
