<?php
    ...
    if(isset($_POST['islami-bank-bangladesh'])){
            ...
            <div class="payment-form">
                  <ul class="list-unstyled">
                    ...
                    <li class="d-flex">
                      ...
                      <p class="mb-0">
                        Bank Name: <span class="text-primary fw-semibold">Islami Bank Bangladesh</span>
                      </p>
                    </li>
    ...
    <script>
        ...
        document.querySelector('.btn-pay').addEventListener('click', function () {
            ...
            if (!file) {
                ...
                formData.append("islami-bank-bangladesh", "<?php echo $payment_id ?>");
                formData.append("payment_slip", file);
        
                $.ajax({
                    type: "POST",
                    url: "<?php echo pp_get_paymentlink($payment_id) ?>?method=islami-bank-bangladesh",
                    data: formData,
                    contentType: false,
                    processData: false,
