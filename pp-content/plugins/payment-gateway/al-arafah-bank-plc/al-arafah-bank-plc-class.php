<?php
$plugin_meta = [
    'Plugin Name'       => 'Al-Arafah Islami Bank',
    'Description'       => 'Accept Al-Arafah Islami Bank payments directly from customers. Perfect for freelancers and small businesses.',
    'Version'           => '1.0.0',
    'Author'            => 'PipraPay',
...
function al_arafah_bank_plc_admin_page() {
...
function al_arafah_bank_plc_checkout_page($payment_id) {
