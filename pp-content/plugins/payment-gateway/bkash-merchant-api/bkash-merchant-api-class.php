<?php
$plugin_meta = [
    'Plugin Name'       => 'bKash Merchant API',
    'Description'       => 'Accept bKash Merchant API payments directly from customers. Perfect for freelancers and small businesses.',
    'Version'           => '1.0.0',
    'Author'            => 'PipraPay',
...
function bkash_merchant_api_admin_page() {
...
function bkash_merchant_api_checkout_page($payment_id) {
