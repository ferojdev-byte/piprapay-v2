        ...
        <div class="d-grid gap-3 gap-lg-5">
          ...
          <div class="card">
            ...
            <div class="card-body">
                <div class="row mb-4">
                  <div class="col-sm-6">
                    <label for="bkash_username" class="col-sm-12 col-form-label form-label">Username </label>
                    <div class="input-group">
                        <input type="text" class="form-control" name="bkash_username" id="bkash_username" value="<?= htmlspecialchars($settings['bkash_username'] ?? '') ?>">
                    </div>
                    <div class="text-secondary mt-2"> </div>
                  </div>

                  <div class="col-sm-6">
                    <label for="bkash_password" class="col-sm-12 col-form-label form-label">Password </label>
                    <div class="input-group">
                        <input type="text" class="form-control" name="bkash_password" id="bkash_password" value="<?= htmlspecialchars($settings['bkash_password'] ?? '') ?>">
                    </div>
                    <div class="text-secondary mt-2"> </div>
                  </div>
                  
                  <div class="col-sm-6">
                    <label for="bkash_app_key" class="col-sm-12 col-form-label form-label">App Key</label>
                    <div class="input-group">
                        <input type="text" class="form-control" name="bkash_app_key" id="bkash_app_key" value="<?= htmlspecialchars($settings['bkash_app_key'] ?? '') ?>">
                    </div>
                    <div class="text-secondary mt-2"> </div>
                  </div>
                  
                  <div class="col-sm-6">
                    <label for="bkash_secret_key" class="col-sm-12 col-form-label form-label">App Secret Key</label>
                    <div class="input-group">
                        <input type="text" class="form-control" name="bkash_secret_key" id="bkash_secret_key" value="<?= htmlspecialchars($settings['bkash_secret_key'] ?? '') ?>">
                    </div>
                    <div class="text-secondary mt-2"> </div>
                  </div>
                  
                  <div class="col-sm-6">
                    <label for="bkash_mode" class="col-sm-12 col-form-label form-label">Mode</label>
                    <div class="input-group">
                      <select class="form-control" name="bkash_mode" id="bkash_mode">
                        <?php $bkash_mode = isset($settings['bkash_mode']) ? strtolower($settings['bkash_mode']) : ''; ?>
                        <option value="sandbox" <?php echo ($bkash_mode === 'sandbox') ? 'selected' : ''; ?>>Sandbox</option>
                        <option value="live" <?php echo ($bkash_mode === 'live') ? 'selected' : ''; ?>>Live</option>
                      </select>
                    </div>
                    <div class="text-secondary mt-2"> </div>
                  </div>
