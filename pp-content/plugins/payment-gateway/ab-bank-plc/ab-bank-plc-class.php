<?php
$plugin_meta = [
    'Plugin Name'       => 'AB Bank PLC',
    'Description'       => 'Accept AB Bank PLC payments directly from customers. Perfect for freelancers and small businesses.',
    'Version'           => '1.0.0',
    'Author'            => 'PipraPay',
...
function ab_bank_plc_admin_page() {
...
function ab_bank_plc_checkout_page($payment_id) {
