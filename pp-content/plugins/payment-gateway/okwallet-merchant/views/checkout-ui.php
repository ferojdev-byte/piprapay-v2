<?php
    ...
    if(isset($_POST['okwallet-merchant'])){
        if($_POST['trxid'] == ""){
            ...
            if($check_transactionid['status'] == false){
                $verify_status = pp_verify_transaction($payment_id, $plugin_slug, 'OkWallet', $_POST['trxid']);
            ...
            <div class="payment-form">
                  <ul class="list-unstyled">
                    ...
                    <li class="d-flex">
                      ...
                      <p class="mb-0">
                        Dial <span class="text-primary fw-semibold">*269#</span> or open the <span class="text-primary fw-semibold">OkWallet</span> app.
                      </p>
                    </li>
                    ...
                    <li class="d-flex">
                      ...
                      <p class="mb-0">
                        Choose: <span class="text-primary fw-semibold">Make Payment</span>
                      </p>
                    </li>
                    ...
                    <li class="d-flex">
                      ...
                      <p class="mb-0">
                        Now enter your <span class="text-primary fw-semibold">OkWallet</span> PIN to confirm.
                      </p>
                    </li>
    ...
    <script>
        ...
        document.querySelector('.btn-pay').addEventListener('click', function() {
            ...
            if(trxid == ""){
                ...
                ({
                    type: "POST",
                    url: "<?php echo pp_get_paymentlink($payment_id)?>?method=okwallet-merchant",
                    data: { "okwallet-merchant": "<?php echo $payment_id?>", "trxid": trxid, "number": number },
