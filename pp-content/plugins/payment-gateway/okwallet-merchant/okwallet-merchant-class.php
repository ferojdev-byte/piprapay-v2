<?php
$plugin_meta = [
    'Plugin Name'       => 'OkWallet merchant',
    'Description'       => 'Accept OkWallet merchant payments directly from customers. Perfect for freelancers and small businesses.',
    'Version'           => '1.0.0',
    'Author'            => 'PipraPay',
...
function okwallet_merchant_admin_page() {
...
function okwallet_merchant_checkout_page($payment_id) {
