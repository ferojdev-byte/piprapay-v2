        ...
        <div class="d-grid gap-3 gap-lg-5">
          ...
          <div class="card">
            ...
            <div class="card-body">
                <div class="row mb-4">
                  <div class="col-sm-6">
                    <label for="paypal_client_id" class="col-sm-12 col-form-label form-label">PayPal Client ID</label>
                    <div class="input-group">
                        <input type="text" class="form-control" name="paypal_client_id" id="paypal_client_id" value="<?= htmlspecialchars($settings['paypal_client_id'] ?? '') ?>">
                    </div>
                    <div class="text-secondary mt-2"> </div>
                  </div>

                  <div class="col-sm-6">
                    <label for="paypal_secret" class="col-sm-12 col-form-label form-label">PayPal Secret</label>
                    <div class="input-group">
                        <input type="text" class="form-control" name="paypal_secret" id="paypal_secret" value="<?= htmlspecialchars($settings['paypal_secret'] ?? '') ?>">
                    </div>
                    <div class="text-secondary mt-2"> </div>
                  </div>
                  
                  <div class="col-sm-6">
                    <label for="paypal_mode" class="col-sm-12 col-form-label form-label">Mode</label>
                    <div class="input-group">
                      <select class="form-control" name="paypal_mode" id="paypal_mode">
                        <?php $paypal_mode = isset($settings['paypal_mode']) ? strtolower($settings['paypal_mode']) : ''; ?>
                        <option value="sandbox" <?php echo ($paypal_mode === 'sandbox') ? 'selected' : ''; ?>>Sandbox</option>
