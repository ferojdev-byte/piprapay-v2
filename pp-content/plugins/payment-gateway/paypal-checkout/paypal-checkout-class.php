<?php
$plugin_meta = [
    'Plugin Name'       => 'PayPal Checkout',
    'Description'       => 'Accept PayPal Checkout payments directly from customers. Perfect for freelancers and small businesses.',
    'Version'           => '1.0.0',
    'Author'            => 'PipraPay',
...
function paypal_checkout_admin_page() {
...
function paypal_checkout_checkout_page($payment_id) {
