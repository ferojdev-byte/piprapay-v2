<?php
$plugin_meta = [
    'Plugin Name'       => 'PayPal Manual',
    'Description'       => 'Accept PayPal Manual payments directly from customers. Perfect for freelancers and small businesses.',
    'Version'           => '1.0.0',
    'Author'            => 'PipraPay',
...
function paypal_manual_admin_page() {
...
function paypal_manual_checkout_page($payment_id) {
