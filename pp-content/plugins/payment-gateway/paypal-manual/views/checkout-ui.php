<?php
    ...
    if(isset($_POST['paypal-manual'])){
        if($_POST['trxid'] == ""){
            echo json_encode(["status" => "false", "message" => "Invalid Transaction ID"]);
        }else{
            if($_POST['email_address'] == ""){
                echo json_encode(["status" => "false", "message" => "Invalid paypal email address"]);
            }else{
            ...
            <div class="payment-form">
                  <ul class="list-unstyled">
                    ...
                    <li class="d-flex">
                      ...
                      <p class="mb-0">
                         Open the <span class="text-primary fw-semibold">PayPal</span> app or website.
                      </p>
                    </li>
                ...
                <div class="mb-3 email-address-box">
                    ...
                    <input type="text" class="form-control email-address" placeholder="Enter paypal email address">
                </div>
    ...
    <script>
        ...
        document.querySelector('.btn-pay').addEventListener('click', function() {
            ...
            if(trxid == ""){
                ...
                if(email_address == ""){
                    document.querySelector(".response").innerHTML = '<div class="alert alert-danger" style="margin-top:10px;margin-bottom:10px"> <i class="fa fa-info-circle me-2"></i> Enter paypal email address</div>';
                }else{
                    ...
                    ({
                        type: "POST",
                        url: "<?php echo pp_get_paymentlink($payment_id)?>?method=paypal-manual",
                        data: { "paypal-manual": "<?php echo $payment_id?>", "trxid": trxid, "email_address": email_address },
