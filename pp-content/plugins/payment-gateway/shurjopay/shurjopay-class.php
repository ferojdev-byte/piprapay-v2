<?php
$plugin_meta = [
    'Plugin Name'       => 'shurjoPay ',
    'Description'       => 'Accept shurjoPay  payments directly from customers. Perfect for freelancers and small businesses.',
    'Version'           => '1.0.0',
    'Author'            => 'PipraPay',
...
function shurjopay_checkout_page($payment_id) {
