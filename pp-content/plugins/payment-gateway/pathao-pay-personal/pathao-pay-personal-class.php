<?php
$plugin_meta = [
    'Plugin Name'       => 'Pathao Pay Personal',
    'Description'       => 'Accept Pathao Pay Personal payments directly from customers. Perfect for freelancers and small businesses.',
    'Version'           => '1.0.0',
    'Author'            => 'PipraPay',
...
function pathao_pay_personal_admin_page() {
...
function pathao_pay_personal_checkout_page($payment_id) {
