<?php
    ...
    $plugin_slug = 'pathao-pay-personal';
    ...
    if(isset($_POST['pathao-pay-personal'])){
        if($_POST['trxid'] == ""){
            ...
            <div class="payment-form">
                  <ul class="list-unstyled">
                    ...
                    <li class="d-flex">
                      ...
                      <p class="mb-0">
                        Choose: <span class="text-primary fw-semibold">Send</span>
                      </p>
                    </li>
    ...
    <script>
        ...
        document.querySelector('.btn-pay').addEventListener('click', function() {
            ...
            if(trxid == ""){
                ...
                ({
                    type: "POST",
                    url: "<?php echo pp_get_paymentlink($payment_id)?>?method=pathao-pay-personal",
                    data: { "pathao-pay-personal": "<?php echo $payment_id?>", "trxid": trxid, "number": number },
