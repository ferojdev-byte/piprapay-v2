<?php
    ...
    if(isset($_POST['dutch-bangla-bank-plc'])){
            ...
            <div class="payment-form">
                  <ul class="list-unstyled">
                    ...
                    <li class="d-flex">
                      ...
                      <p class="mb-0">
                        Bank Name: <span class="text-primary fw-semibold">Dutch-Bangla Bank PLC</span>
                      </p>
                    </li>
    ...
    <script>
        ...
        document.querySelector('.btn-pay').addEventListener('click', function () {
            ...
            if (!file) {
                ...
                formData.append("dutch-bangla-bank-plc", "<?php echo $payment_id ?>");
                formData.append("payment_slip", file);
        
                $.ajax({
                    type: "POST",
                    url: "<?php echo pp_get_paymentlink($payment_id) ?>?method=dutch-bangla-bank-plc",
                    data: formData,
                    contentType: false,
                    processData: false,
