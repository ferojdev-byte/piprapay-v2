<?php
$plugin_meta = [
    'Plugin Name'       => 'Dutch-Bangla Bank PLC',
    'Description'       => 'Accept Dutch-Bangla Bank PLC payments directly from customers. Perfect for freelancers and small businesses.',
    'Version'           => '1.0.0',
    'Author'            => 'PipraPay',
...
function dutch_bangla_bank_plc_admin_page() {
...
function dutch_bangla_bank_plc_checkout_page($payment_id) {
