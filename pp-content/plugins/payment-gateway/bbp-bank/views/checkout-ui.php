            ...
            <div class="payment-form">
                  <ul class="list-unstyled">
                    ...
                    <li class="d-flex">
                      ...
                      <p class="mb-0">
                        Bank Name: <span class="text-primary fw-semibold">BRAC Bank PLC</span>
                      </p>
                    </li>
    ...
    <script>
        ...
        document.querySelector('.btn-pay').addEventListener('click', function () {
            ...
            if (!file) {
                ...
                formData.append("bbp-bank", "<?php echo $payment_id ?>");
                formData.append("payment_slip", file);
        
                $.ajax({
                    type: "POST",
                    url: "<?php echo pp_get_paymentlink($payment_id) ?>?method=bbp-bank",
                    data: formData,
                    contentType: false,
                    processData: false,
