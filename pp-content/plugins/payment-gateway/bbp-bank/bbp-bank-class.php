<?php
$plugin_meta = [
    'Plugin Name'       => 'BRAC Bank PLC',
    'Description'       => 'Accept BRAC Bank PLC payments directly from customers. Perfect for freelancers and small businesses.',
    'Version'           => '1.0.0',
    'Author'            => 'PipraPay',
...
function bbp_bank_checkout_page($payment_id) {
