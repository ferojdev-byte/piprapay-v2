<?php
$plugin_meta = [
    'Plugin Name'       => 'IFIC Bank PLC',
    'Description'       => 'Accept IFIC Bank PLC payments directly from customers. Perfect for freelancers and small businesses.',
    'Version'           => '1.0.0',
    'Author'            => 'PipraPay',
...
function ific_bank_plc_admin_page() {
...
function ific_bank_plc_checkout_page($payment_id) {
