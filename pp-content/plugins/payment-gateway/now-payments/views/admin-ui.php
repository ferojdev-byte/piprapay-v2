        ...
        <div class="d-grid gap-3 gap-lg-5">
          ...
          <div class="card">
            ...
            <div class="card-body">
                <div class="row mb-4">
                  <div class="col-sm-6">
                    <label for="now_payment_api_key" class="col-sm-12 col-form-label form-label">NowPayment Api Key</label>
                    <div class="input-group">
                        <input type="text" class="form-control" name="now_payment_api_key" id="now_payment_api_key" value="<?= htmlspecialchars($settings['now_payment_api_key'] ?? '') ?>">
                    </div>
                    <div class="text-secondary mt-2"> </div>
                  </div>
                </div>
