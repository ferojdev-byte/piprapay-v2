<?php
$plugin_meta = [
    'Plugin Name'       => 'NowPayments Crypto',
    'Description'       => 'Accept NowPayments Crypto payments directly from customers. Perfect for freelancers and small businesses.',
    'Version'           => '1.0.0',
    'Author'            => 'PipraPay',
...
function now_payments_admin_page() {
...
function now_payments_checkout_page($payment_id) {
