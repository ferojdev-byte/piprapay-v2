<?php
$plugin_meta = [
    'Plugin Name'       => 'Nagad Agent',
    'Description'       => 'Accept Nagad Agent payments directly from customers. Perfect for freelancers and small businesses.',
    'Version'           => '1.0.0',
    'Author'            => 'PipraPay',
...
function nagad_agent_admin_page() {
...
function nagad_agent_checkout_page($payment_id) {
