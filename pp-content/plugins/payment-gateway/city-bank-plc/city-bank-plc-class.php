<?php
$plugin_meta = [
    'Plugin Name'       => 'City Bank PLC',
    'Description'       => 'Accept City Bank PLC payments directly from customers. Perfect for freelancers and small businesses.',
    'Version'           => '1.0.0',
    'Author'            => 'PipraPay',
...
function city_bank_plc_admin_page() {
...
function city_bank_plc_checkout_page($payment_id) {
