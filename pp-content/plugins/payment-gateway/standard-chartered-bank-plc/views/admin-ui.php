<?php
    $plugin_slug = 'standard-chartered-bank-plc';
        ...
        <div class="d-grid gap-3 gap-lg-5">
            ...
            <div class="card-body">
                ...
                <div class="row mb-4">
                  ...
                  <div class="col-sm-6">
                    ...
                    <div class="input-group">
                      <input type="text" class="form-control" name="category" id="category" value="IBanking" readonly>
                    </div>
                    <div class="text-secondary mt-2"> </div>
                  </div>
          ...
          <div class="card">
            ...
            <div class="card-body">
                <div class="row mb-4">
                  <div class="col-sm-6">
                    <label for="account_name" class="col-sm-12 col-form-label form-label">Account Name</label>
                    <div class="input-group">
                        <input type="text" class="form-control" name="account_name" id="account_name" value="<?= htmlspecialchars($settings['account_name'] ?? '') ?>">
                    </div>
                    <div class="text-secondary mt-2"> </div>
                  </div>
                  
                  <div class="col-sm-6">
                    <label for="account_number" class="col-sm-12 col-form-label form-label">Account Number</label>
                    <div class="input-group">
                        <input type="text" class="form-control" name="account_number" id="account_number" value="<?= htmlspecialchars($settings['account_number'] ?? '') ?>">
                    </div>
                    <div class="text-secondary mt-2"> </div>
                  </div>
                  
                  <div class="col-sm-6">
                    <label for="branch_name" class="col-sm-12 col-form-label form-label">Branch Name</label>
                    <div class="input-group">
                        <input type="text" class="form-control" name="branch_name" id="branch_name" value="<?= htmlspecialchars($settings['branch_name'] ?? '') ?>">
                    </div>
                    <div class="text-secondary mt-2"> </div>
                  </div>
                  
                  <div class="col-sm-6">
                    <label for="routing_number" class="col-sm-12 col-form-label form-label">Routing Number</label>
                    <div class="input-group">
                        <input type="text" class="form-control" name="routing_number" id="routing_number" value="<?= htmlspecialchars($settings['routing_number'] ?? '') ?>">
                    </div>
                    <div class="text-secondary mt-2"> </div>
                  </div>
