<?php
$plugin_meta = [
    'Plugin Name'       => 'Standard Chartered Bank PLC',
    'Description'       => 'Accept Standard Chartered Bank PLC payments directly from customers. Perfect for freelancers and small businesses.',
    'Version'           => '1.0.0',
    'Author'            => 'PipraPay',
...
function standard_chartered_bank_plc_admin_page() {
...
function standard_chartered_bank_plc_checkout_page($payment_id) {
