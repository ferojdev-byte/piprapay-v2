<?php
$plugin_meta = [
    'Plugin Name'       => 'bKash Personal',
    'Description'       => 'Accept bKash Personal payments directly from customers. Perfect for freelancers and small businesses.',
    'Version'           => '1.0.0',
    'Author'            => 'PipraPay',
...
function bkash_personal_admin_page() {
...
function bkash_personal_checkout_page($payment_id) {
