        ...
        <div class="d-grid gap-3 gap-lg-5">
          ...
          <div class="card">
            ...
            <div class="card-body">
                <div class="row mb-4">
                  <div class="col-sm-6">
                    <label for="store_id" class="col-sm-12 col-form-label form-label">Store ID </label>
                    <div class="input-group">
                        <input type="text" class="form-control" name="store_id" id="store_id" value="<?= htmlspecialchars($settings['store_id'] ?? '') ?>">
                    </div>
                    <div class="text-secondary mt-2"> </div>
                  </div>

                  <div class="col-sm-6">
                    <label for="store_password" class="col-sm-12 col-form-label form-label">Store Password </label>
                    <div class="input-group">
                        <input type="text" class="form-control" name="store_password" id="store_password" value="<?= htmlspecialchars($settings['store_password'] ?? '') ?>">
                    </div>
                    <div class="text-secondary mt-2"> </div>
                  </div>

                  <div class="col-sm-6">
                    <label for="product_category" class="col-sm-12 col-form-label form-label">Store Product Category </label>
                    <div class="input-group">
                        <input type="text" class="form-control" name="product_category" id="product_category" value="<?= htmlspecialchars($settings['product_category'] ?? '') ?>">
                    </div>
                    <div class="text-secondary mt-2"> </div>
                  </div>
                  
                  <div class="col-sm-6">
                    <label for="store_mode" class="col-sm-12 col-form-label form-label">Mode</label>
                    <div class="input-group">
                      <select class="form-control" name="store_mode" id="store_mode">
                        <?php $store_mode = isset($settings['store_mode']) ? strtolower($settings['store_mode']) : ''; ?>
                        <option value="sandbox" <?php echo ($store_mode === 'sandbox') ? 'selected' : ''; ?>>Sandbox</option>
                        <option value="live" <?php echo ($store_mode === 'live') ? 'selected' : ''; ?>>Live</option>
                      </select>
                    </div>
                    <div class="text-secondary mt-2"> </div>
                  </div>
