...
$plugin_meta = [
    ...
    'Description'       => 'Accept SSLCommerz payments directly from customers. Perfect for freelancers and small businesses.',
    'Version'           => '1.0.0',
    'Author'            => 'PipraPay',
...
function sslcommerz_admin_page() {
...
function sslcommerz_checkout_page($payment_id) {
