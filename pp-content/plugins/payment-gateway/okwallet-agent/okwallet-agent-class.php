<?php
$plugin_meta = [
    'Plugin Name'       => 'OkWallet Agent',
    'Description'       => 'Accept OkWallet Agent payments directly from customers. Perfect for freelancers and small businesses.',
    'Version'           => '1.0.0',
    'Author'            => 'PipraPay',
...
function okwallet_agent_admin_page() {
...
function okwallet_agent_checkout_page($payment_id) {
