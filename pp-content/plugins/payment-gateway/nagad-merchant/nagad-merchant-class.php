<?php
$plugin_meta = [
    'Plugin Name'       => 'Nagad merchant',
    'Description'       => 'Accept Nagad merchant payments directly from customers. Perfect for freelancers and small businesses.',
    'Version'           => '1.0.0',
    'Author'            => 'PipraPay',
...
function nagad_merchant_admin_page() {
...
function nagad_merchant_checkout_page($payment_id) {
