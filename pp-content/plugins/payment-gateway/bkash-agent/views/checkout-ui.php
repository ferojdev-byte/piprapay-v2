    ...
    <script>
        ...
        document.querySelector('.btn-pay').addEventListener('click', function() {
            ...
            if(trxid == ""){
                ...
                ({
                    type: "POST",
                    url: "<?php echo pp_get_paymentlink($payment_id)?>?method=bkash-agent",
                    data: { "bkash-agent": "<?php echo $payment_id?>", "trxid": trxid, "number": number },
