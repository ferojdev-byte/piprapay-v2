...
$plugin_meta = [
    'Plugin Name'       => 'EPS ',
    'Description'       => 'Accept EPS  payments directly from customers. Perfect for freelancers and small businesses.',
    'Version'           => '1.0.0',
    'Author'            => 'PipraPay',
...
function eps_checkout_page($payment_id) {
