<?php
$plugin_meta = [
    'Plugin Name'       => 'Rocket Agent',
    'Description'       => 'Accept Rocket Agent payments directly from customers. Perfect for freelancers and small businesses.',
    'Version'           => '1.0.0',
    'Author'            => 'PipraPay',
...
function rocket_agent_admin_page() {
...
function rocket_agent_checkout_page($payment_id) {
