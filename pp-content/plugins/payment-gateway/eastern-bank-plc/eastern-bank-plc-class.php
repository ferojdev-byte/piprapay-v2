<?php
$plugin_meta = [
    'Plugin Name'       => 'Eastern Bank PLC',
    'Description'       => 'Accept Eastern Bank PLC payments directly from customers. Perfect for freelancers and small businesses.',
    'Version'           => '1.0.0',
    'Author'            => 'PipraPay',
...
function eastern_bank_plc_admin_page() {
...
function eastern_bank_plc_checkout_page($payment_id) {
