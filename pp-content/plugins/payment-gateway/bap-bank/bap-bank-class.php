<?php
$plugin_meta = [
    'Plugin Name'       => 'Bank Asia PLC',
    'Description'       => 'Accept Bank Asia PLC payments directly from customers. Perfect for freelancers and small businesses.',
    'Version'           => '1.0.0',
    'Author'            => 'PipraPay',
...
function bap_bank_checkout_page($payment_id) {
