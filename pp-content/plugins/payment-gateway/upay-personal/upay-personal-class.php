<?php
$plugin_meta = [
    'Plugin Name'       => 'Upay Personal',
    'Description'       => 'Accept Upay Personal payments directly from customers. Perfect for freelancers and small businesses.',
    'Version'           => '1.0.0',
    'Author'            => 'PipraPay',
...
function upay_personal_admin_page() {
...
function upay_personal_checkout_page($payment_id) {
