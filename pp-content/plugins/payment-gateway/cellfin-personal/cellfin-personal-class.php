<?php
$plugin_meta = [
    'Plugin Name'       => 'Cellfin Personal',
    'Description'       => 'Accept Cellfin Personal payments directly from customers. Perfect for freelancers and small businesses.',
    'Version'           => '1.0.0',
    'Author'            => 'PipraPay',
...
function cellfin_personal_admin_page() {
...
function cellfin_personal_checkout_page($payment_id) {
