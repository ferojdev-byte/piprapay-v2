<?php
$plugin_meta = [
    'Plugin Name'       => 'Payoneer Manual',
    'Description'       => 'Accept Payoneer Manual payments directly from customers. Perfect for freelancers and small businesses.',
    'Version'           => '1.0.0',
    'Author'            => 'PipraPay',
...
function payoneer_manual_admin_page() {
...
function payoneer_manual_checkout_page($payment_id) {
