        ...
        <div class="d-grid gap-3 gap-lg-5">
          ...
          <div class="card">
            ...
            <div class="card-body">
                <div class="row mb-4">
                  <div class="col-sm-6">
                    <label for="account_email" class="col-sm-12 col-form-label form-label">Payoneer Email Address</label>
                    <div class="input-group">
                        <input type="text" class="form-control" name="account_email" id="account_email" value="<?= htmlspecialchars($settings['account_email'] ?? '') ?>">
                    </div>
                    <div class="text-secondary mt-2"> </div>
                  </div>
                </div>
