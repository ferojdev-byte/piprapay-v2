<?php
$plugin_meta = [
    'Plugin Name'       => 'Uttara Bank PLC',
    'Description'       => 'Accept Uttara Bank PLC payments directly from customers. Perfect for freelancers and small businesses.',
    'Version'           => '1.0.0',
    'Author'            => 'PipraPay',
...
function uttara_bank_plc_admin_page() {
...
function uttara_bank_plc_checkout_page($payment_id) {
