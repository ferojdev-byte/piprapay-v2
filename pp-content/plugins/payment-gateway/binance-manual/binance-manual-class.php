<?php
$plugin_meta = [
    'Plugin Name'       => 'Binance Manual',
    'Description'       => 'Accept Binance Manual payments directly from customers. Perfect for freelancers and small businesses.',
    'Version'           => '1.0.0',
    'Author'            => 'PipraPay',
...
function binance_manual_admin_page() {
...
function binance_manual_checkout_page($payment_id) {
