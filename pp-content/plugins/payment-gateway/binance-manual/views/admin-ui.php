        ...
        <div class="d-grid gap-3 gap-lg-5">
          ...
          <div class="card">
            ...
            <div class="card-body">
                <div class="row mb-4">
                  <div class="col-sm-6">
                    <label for="binance_email_id" class="col-sm-12 col-form-label form-label">Binance Email or ID</label>
                    <div class="input-group">
                        <input type="text" class="form-control" name="binance_email_id" id="binance_email_id" value="<?= htmlspecialchars($settings['binance_email_id'] ?? '') ?>">
                    </div>
                    <div class="text-secondary mt-2"> </div>
                  </div>
                </div>
