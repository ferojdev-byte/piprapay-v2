<?php
$plugin_meta = [
    'Plugin Name'       => 'CashMaal',
    'Description'       => 'Accept CashMaal payments directly from customers. Perfect for freelancers and small businesses.',
    'Version'           => '1.0.0',
    'Author'            => 'PipraPay',
...
function cashmaal_checkout_page($payment_id) {
