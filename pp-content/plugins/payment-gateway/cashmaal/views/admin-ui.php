        ...
        <div class="d-grid gap-3 gap-lg-5">
          ...
          <div class="card">
            ...
            <div class="card-body">
                <div class="row mb-4">
                  <div class="col-sm-6">
                    <label for="web_id" class="col-sm-12 col-form-label form-label">Web ID</label>
                    <div class="input-group">
                        <input type="text" class="form-control" name="web_id" id="web_id" value="<?= htmlspecialchars($settings['web_id'] ?? '') ?>">
                    </div>
                    <div class="text-secondary mt-2"> </div>
                  </div>
