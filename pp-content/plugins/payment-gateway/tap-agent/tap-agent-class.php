<?php
$plugin_meta = [
    'Plugin Name'       => 'Tap Agent',
    'Description'       => 'Accept Tap Agent payments directly from customers. Perfect for freelancers and small businesses.',
    'Version'           => '1.0.0',
    'Author'            => 'PipraPay',
...
function tap_agent_checkout_page($payment_id) {
