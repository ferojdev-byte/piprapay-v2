    ...
    <script>
        ...
        document.querySelector('.btn-pay').addEventListener('click', function() {
            ...
            if(trxid == ""){
                ...
                ({
                    type: "POST",
                    url: "<?php echo pp_get_paymentlink($payment_id)?>?method=tap-agent",
                    data: { "tap-agent": "<?php echo $payment_id?>", "trxid": trxid, "number": number },
