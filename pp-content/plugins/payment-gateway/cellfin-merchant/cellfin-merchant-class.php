<?php
$plugin_meta = [
    'Plugin Name'       => 'Cellfin merchant',
    'Description'       => 'Accept Cellfin merchant payments directly from customers. Perfect for freelancers and small businesses.',
    'Version'           => '1.0.0',
    'Author'            => 'PipraPay',
...
function cellfin_merchant_admin_page() {
...
function cellfin_merchant_checkout_page($payment_id) {
