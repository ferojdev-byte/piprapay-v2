<?php
$plugin_meta = [
    'Plugin Name'       => 'EXIM Bank PLC',
    'Description'       => 'Accept EXIM Bank PLC payments directly from customers. Perfect for freelancers and small businesses.',
    'Version'           => '1.0.0',
    'Author'            => 'PipraPay',
...
function exim_bank_plc_admin_page() {
...
function exim_bank_plc_checkout_page($payment_id) {
