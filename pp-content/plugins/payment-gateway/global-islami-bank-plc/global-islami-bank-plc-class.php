<?php
$plugin_meta = [
    'Plugin Name'       => 'Global Islami Bank PLC',
    'Description'       => 'Accept Global Islami Bank PLC payments directly from customers. Perfect for freelancers and small businesses.',
    'Version'           => '1.0.0',
    'Author'            => 'PipraPay',
...
function global_islami_bank_plc_admin_page() {
...
function global_islami_bank_plc_checkout_page($payment_id) {
