<?php
$plugin_meta = [
    'Plugin Name'       => 'bKash Merchant',
    'Description'       => 'Accept bKash Merchant payments directly from customers. Perfect for freelancers and small businesses.',
    'Version'           => '1.0.0',
    'Author'            => 'PipraPay',
...
function bkash_merchant_admin_page() {
...
function bkash_merchant_checkout_page($payment_id) {
