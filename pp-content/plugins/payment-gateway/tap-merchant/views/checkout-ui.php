    ...
    if(isset($_POST['tap-merchant'])){
        if($_POST['trxid'] == ""){
            ...
            if($check_transactionid['status'] == false){
                $verify_status = pp_verify_transaction($payment_id, $plugin_slug, 'Tap', $_POST['trxid']);
            ...
            <div class="payment-form">
                  <ul class="list-unstyled">
                    ...
                    <li class="d-flex">
                      ...
                      <p class="mb-0">
                        Dial <span class="text-primary fw-semibold">*733#</span> or open the <span class="text-primary fw-semibold">Tap</span> app.
                      </p>
                    </li>
                    ...
                    <li class="d-flex">
                      ...
                      <p class="mb-0">
                        Now enter your <span class="text-primary fw-semibold">Tap</span> PIN to confirm.
                      </p>
                    </li>
    ...
    <script>
        ...
        document.querySelector('.btn-pay').addEventListener('click', function() {
            ...
            if(trxid == ""){
                ...
                ({
                    type: "POST",
                    url: "<?php echo pp_get_paymentlink($payment_id)?>?method=tap-merchant",
                    data: { "tap-merchant": "<?php echo $payment_id?>", "trxid": trxid, "number": number },
