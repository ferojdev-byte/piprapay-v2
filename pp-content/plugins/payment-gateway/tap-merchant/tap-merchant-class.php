<?php
$plugin_meta = [
    'Plugin Name'       => 'Tap merchant',
    'Description'       => 'Accept Tap merchant payments directly from customers. Perfect for freelancers and small businesses.',
    'Version'           => '1.0.0',
    'Author'            => 'PipraPay',
...
function tap_merchant_admin_page() {
...
function tap_merchant_checkout_page($payment_id) {
