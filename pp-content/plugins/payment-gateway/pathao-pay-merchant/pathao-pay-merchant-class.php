<?php
$plugin_meta = [
    'Plugin Name'       => 'Pathao Pay Merchant',
    'Description'       => 'Accept Pathao Pay Merchant payments directly from customers. Perfect for freelancers and small businesses.',
    'Version'           => '1.0.0',
    'Author'            => 'PipraPay',
...
function pathao_pay_merchant_admin_page() {
...
function pathao_pay_merchant_checkout_page($payment_id) {
