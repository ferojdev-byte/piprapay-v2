<?php
    ...
    $plugin_slug = 'pathao-pay-merchant';
    ...
    if(isset($_POST['pathao-pay-merchant'])){
        if($_POST['trxid'] == ""){
            ...
            if($check_transactionid['status'] == false){
                $verify_status = pp_verify_transaction($payment_id, $plugin_slug, 'Pathao Pay', $_POST['trxid']);
            ...
            <div class="payment-form">
                  <ul class="list-unstyled">
                    ...
                    <li class="d-flex">
                      ...
                      <p class="mb-0">
                        Open the <span class="text-primary fw-semibold">Pathao Pay</span> app.
                      </p>
                    </li>
                    ...
                    <li class="d-flex">
                      ...
                      <p class="mb-0">
                        Choose: <span class="text-primary fw-semibold">Payment</span>
                      </p>
                    </li>
                    ...
                    <li class="d-flex">
                      ...
                      <p class="mb-0">
                        Now enter your <span class="text-primary fw-semibold">Pathao Pay</span> PIN to confirm.
                      </p>
                    </li>
    ...
    <script>
        ...
        document.querySelector('.btn-pay').addEventListener('click', function() {
            ...
            if(trxid == ""){
                ...
                ({
                    type: "POST",
                    url: "<?php echo pp_get_paymentlink($payment_id)?>?method=pathao-pay-merchant",
                    data: { "pathao-pay-merchant": "<?php echo $payment_id?>", "trxid": trxid, "number": number },
