<?php
$plugin_meta = [
    'Plugin Name'       => 'Payeer Manual',
    'Description'       => 'Accept Payeer Manual payments directly from customers. Perfect for freelancers and small businesses.',
    'Version'           => '1.0.0',
    'Author'            => 'PipraPay',
...
function payeer_manual_admin_page() {
...
function payeer_manual_checkout_page($payment_id) {
