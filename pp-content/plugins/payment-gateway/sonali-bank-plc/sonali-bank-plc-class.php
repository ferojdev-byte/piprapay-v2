<?php
$plugin_meta = [
    'Plugin Name'       => 'Sonali Bank PLC',
    'Description'       => 'Accept Sonali Bank PLC payments directly from customers. Perfect for freelancers and small businesses.',
    'Version'           => '1.0.0',
    'Author'            => 'PipraPay',
...
function sonali_bank_plc_admin_page() {
...
function sonali_bank_plc_checkout_page($payment_id) {
