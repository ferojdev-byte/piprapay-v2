<?php
$plugin_meta = [
    'Plugin Name'       => 'Trust Bank PLC',
    'Description'       => 'Accept Trust Bank PLC payments directly from customers. Perfect for freelancers and small businesses.',
    'Version'           => '1.0.0',
    'Author'            => 'PipraPay',
...
function trust_bank_plc_admin_page() {
...
function trust_bank_plc_checkout_page($payment_id) {
