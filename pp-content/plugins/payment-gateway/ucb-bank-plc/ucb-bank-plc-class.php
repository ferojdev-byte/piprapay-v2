<?php
$plugin_meta = [
    'Plugin Name'       => 'UCB Bank PLC',
    'Description'       => 'Accept UCB Bank PLC payments directly from customers. Perfect for freelancers and small businesses.',
    'Version'           => '1.0.0',
    'Author'            => 'PipraPay',
...
function ucb_bank_plc_admin_page() {
...
function ucb_bank_plc_checkout_page($payment_id) {
