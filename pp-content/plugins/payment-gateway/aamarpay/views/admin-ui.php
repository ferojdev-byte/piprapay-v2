          ...
          <div class="card">
            ...
            <div class="card-body">
                <div class="row mb-4">
                  ...
                  <div class="col-sm-6">
                    <label for="signature_key" class="col-sm-12 col-form-label form-label">Signature Key </label>
                    <div class="input-group">
                        <input type="text" class="form-control" name="signature_key" id="signature_key" value="<?= htmlspecialchars($settings['signature_key'] ?? '') ?>">
                    </div>
                    <div class="text-secondary mt-2"> </div>
                  </div>
