<?php
$plugin_meta = [
    'Plugin Name'       => 'aamarPay',
    'Description'       => 'Accept aamarPay payments directly from customers. Perfect for freelancers and small businesses.',
    'Version'           => '1.0.0',
    'Author'            => 'PipraPay',
...
function aamarpay_checkout_page($payment_id) {
