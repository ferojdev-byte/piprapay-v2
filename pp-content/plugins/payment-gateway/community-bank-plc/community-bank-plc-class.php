<?php
$plugin_meta = [
    'Plugin Name'       => 'Community Bank',
    'Description'       => 'Accept Community Bank payments directly from customers. Perfect for freelancers and small businesses.',
    'Version'           => '1.0.0',
    'Author'            => 'PipraPay',
...
function community_bank_plc_admin_page() {
...
function community_bank_plc_checkout_page($payment_id) {
