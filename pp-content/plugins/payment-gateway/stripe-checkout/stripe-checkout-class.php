...
$plugin_meta = [
    ...
    'Description'       => 'Accept Stripe Checkout payments directly from customers. Perfect for freelancers and small businesses.',
    'Version'           => '1.0.0',
    'Author'            => 'PipraPay',
...
function stripe_checkout_admin_page() {
...
function stripe_checkout_checkout_page($payment_id) {
