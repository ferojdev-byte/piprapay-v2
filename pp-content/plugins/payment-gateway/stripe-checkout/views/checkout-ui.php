<?php
    require_once __DIR__ . '/../vendor-stripe/autoload.php';
            ...
            <div class="payment-form">
                <?php
                   ...
                   <?php
                            ...
                            if ($session_id && preg_match('/^cs_(test|live)_[A-Za-z0-9]+$/', $session_id)) {
                                ...
                                if ($payment_intent->status === 'succeeded') {
                                    ...
                                    $trxID = $charge ? $charge->id : $payment_intent->id;
                                    $payerAccount = $session->customer_email ?? ($charge->billing_details->email ?? 'Unknown');
                   ...
                   <?php
                        ...
                        $amount_in_cents = intval(round($transaction_amount * 100));
                        ...
                        $checkout_session = \Stripe\Checkout\Session::create([
                            ...
                            'line_items' => [[
                                'price_data' => [
                                    'currency' => 'usd',
                                    'unit_amount' => $amount_in_cents, // e.g., $500 => 50000
                                    'product_data' => [
                                        'name' => 'Product',
                                    ],
                                ],
                            ...
                            'mode' => 'payment',
                            'success_url' => getCurrentUrl() . $separator . "status=success&session_id={CHECKOUT_SESSION_ID}",
