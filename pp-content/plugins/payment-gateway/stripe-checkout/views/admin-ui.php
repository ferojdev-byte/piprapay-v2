        ...
        <div class="d-grid gap-3 gap-lg-5">
          ...
          <div class="card">
            ...
            <div class="card-body">
                <div class="row mb-4">
                  <div class="col-sm-6">
                    <label for="stripe_secret_key" class="col-sm-12 col-form-label form-label">Stripe Secret Key</label>
                    <div class="input-group">
                        <input type="text" class="form-control" name="stripe_secret_key" id="stripe_secret_key" value="<?= htmlspecialchars($settings['stripe_secret_key'] ?? '') ?>">
                    </div>
                    <div class="text-secondary mt-2"> </div>
                  </div>

                  <div class="col-sm-6">
                    <label for="stripe_webhook_secret" class="col-sm-12 col-form-label form-label">Stripe Webhook Secret</label>
                    <div class="input-group">
                        <input type="text" class="form-control" name="stripe_webhook_secret" id="stripe_webhook_secret" value="<?= htmlspecialchars($settings['stripe_webhook_secret'] ?? '') ?>">
                    </div>
                    <div class="text-secondary mt-2"> </div>
                  </div>
