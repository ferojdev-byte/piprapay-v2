<?php
$plugin_meta = [
    'Plugin Name'       => 'OxaPay Crypto',
    'Description'       => 'Accept OxaPay Crypto payments directly from customers. Perfect for freelancers and small businesses.',
    'Version'           => '1.0.0',
    'Author'            => 'PipraPay',
...
function oxapay_checkout_page($payment_id) {
