<?php
$plugin_meta = [
    'Plugin Name'       => 'Tap Personal',
    'Description'       => 'Accept Tap Personal payments directly from customers. Perfect for freelancers and small businesses.',
    'Version'           => '1.0.0',
    'Author'            => 'PipraPay',
...
function tap_personal_admin_page() {
...
function tap_personal_checkout_page($payment_id) {
