<?php
    ...
    if(isset($_POST['rocket-merchant'])){
        if($_POST['trxid'] == ""){
    ...
    <script>
        ...
        document.querySelector('.btn-pay').addEventListener('click', function() {
            ...
            if(trxid == ""){
                ...
                ({
                    type: "POST",
                    url: "<?php echo pp_get_paymentlink($payment_id)?>?method=rocket-merchant",
                    data: { "rocket-merchant": "<?php echo $payment_id?>", "trxid": trxid, "number": number },
