<?php
$plugin_meta = [
    'Plugin Name'       => 'Rocket merchant',
    'Description'       => 'Accept Rocket merchant payments directly from customers. Perfect for freelancers and small businesses.',
    'Version'           => '1.0.0',
    'Author'            => 'PipraPay',
...
function rocket_merchant_admin_page() {
...
function rocket_merchant_checkout_page($payment_id) {
