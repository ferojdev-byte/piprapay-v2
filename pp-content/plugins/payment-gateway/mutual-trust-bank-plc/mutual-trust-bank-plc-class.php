<?php
$plugin_meta = [
    'Plugin Name'       => 'Mutual Trust Bank PLC',
    'Description'       => 'Accept Mutual Trust Bank PLC payments directly from customers. Perfect for freelancers and small businesses.',
    'Version'           => '1.0.0',
    'Author'            => 'PipraPay',
...
function mutual_trust_bank_plc_admin_page() {
...
function mutual_trust_bank_plc_checkout_page($payment_id) {
