<?php
$plugin_meta = [
    'Plugin Name'       => 'Dhaka Bank PLC',
    'Description'       => 'Accept Dhaka Bank PLC payments directly from customers. Perfect for freelancers and small businesses.',
    'Version'           => '1.0.0',
    'Author'            => 'PipraPay',
...
function dhaka_bank_plc_admin_page() {
...
function dhaka_bank_plc_checkout_page($payment_id) {
