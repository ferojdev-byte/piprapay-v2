    ...
    if(isset($_POST['ipay-personal'])){
        if($_POST['trxid'] == ""){
            ...
            if($check_transactionid['status'] == false){
                $verify_status = pp_verify_transaction($payment_id, $plugin_slug, 'Ipay', $_POST['trxid']);
            ...
            <div class="payment-form">
                  <ul class="list-unstyled">
                    ...
                    <li class="d-flex">
                      ...
                      <p class="mb-0">
                        Go to your <span class="text-primary fw-semibold">IPAY</span> App.
                      </p>
                    </li>
                    ...
                    <li class="d-flex">
                      ...
                      <p class="mb-0">
                        Now enter your <span class="text-primary fw-semibold">Ipay</span> PIN to confirm.
                      </p>
                    </li>
    ...
    <script>
        ...
        document.querySelector('.btn-pay').addEventListener('click', function() {
            ...
            if(trxid == ""){
                ...
                ({
                    type: "POST",
                    url: "<?php echo pp_get_paymentlink($payment_id)?>?method=ipay-personal",
                    data: { "ipay-personal": "<?php echo $payment_id?>", "trxid": trxid, "number": number },
