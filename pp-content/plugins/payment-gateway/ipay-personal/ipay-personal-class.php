<?php
$plugin_meta = [
    'Plugin Name'       => 'Ipay Personal',
    'Description'       => 'Accept Ipay Personal payments directly from customers. Perfect for freelancers and small businesses.',
    'Version'           => '1.0.0',
    'Author'            => 'PipraPay',
...
function ipay_personal_admin_page() {
...
function ipay_personal_checkout_page($payment_id) {
