<?php
$plugin_meta = [
    'Plugin Name'       => 'Pubali Bank PLC',
    'Description'       => 'Accept Pubali Bank PLC payments directly from customers. Perfect for freelancers and small businesses.',
    'Version'           => '1.0.0',
    'Author'            => 'PipraPay',
...
function pubali_bank_plc_admin_page() {
...
function pubali_bank_plc_checkout_page($payment_id) {
