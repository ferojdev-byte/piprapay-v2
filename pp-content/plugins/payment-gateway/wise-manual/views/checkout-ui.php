<?php
    ...
    if(isset($_POST['wise-manual'])){
        if($_POST['trxid'] == ""){
            echo json_encode(["status" => "false", "message" => "Invalid Transaction ID"]);
        }else{
            if($_POST['email_address'] == ""){
                echo json_encode(["status" => "false", "message" => "Invalid wise email address"]);
            }else{
            ...
            <div class="payment-form">
                  <ul class="list-unstyled">
                    ...
                    <li class="d-flex">
                      ...
                      <p class="mb-0">
                         Open the <span class="text-primary fw-semibold">Wise</span> app or website.
                      </p>
                    </li>
                    ...
                    <li class="d-flex">
                      ...
                      <p class="mb-0">
                        ...
                        <span class="text-primary fw-semibold bg-primary bg-opacity-10 px-2 py-1 rounded"><?php echo $settings['email_address']?></span>
                        <button class="btn btn-primary btn-sm ms-2 px-2 py-1 d-inline-flex align-items-center btn-number-copy" onclick="copyText('<?php echo $settings['email_address']?>', 'btn-number-copy')">
                ...
                <div class="mb-3 email-address-box">
                    <label class="form-label">Wise Email Address</label>
                    <input type="text" class="form-control email-address" placeholder="Enter wise email address">
                </div>
    ...
    <script>
        ...
        document.querySelector('.btn-pay').addEventListener('click', function() {
            ...
            if(trxid == ""){
                ...
                if(email_address == ""){
                    document.querySelector(".response").innerHTML = '<div class="alert alert-danger" style="margin-top:10px;margin-bottom:10px"> <i class="fa fa-info-circle me-2"></i> Enter wise email address</div>';
                }else{
                    ...
                    ({
                        type: "POST",
                        url: "<?php echo pp_get_paymentlink($payment_id)?>?method=wise-manual",
                        data: { "wise-manual": "<?php echo $payment_id?>", "trxid": trxid, "email_address": email_address },
