<?php
$plugin_meta = [
    'Plugin Name'       => 'Bangladesh Commerce Bank Limited',
    'Description'       => 'Accept Bangladesh Commerce Bank Limited payments directly from customers. Perfect for freelancers and small businesses.',
    'Version'           => '1.0.0',
    'Author'            => 'PipraPay',
...
function bcbl_bank_checkout_page($payment_id) {
