<?php
    ...
    if(isset($_POST['okwallet-personal'])){
        if($_POST['trxid'] == ""){
    ...
    <script>
        ...
        document.querySelector('.btn-pay').addEventListener('click', function() {
            ...
            if(trxid == ""){
                ...
                ({
                    type: "POST",
                    url: "<?php echo pp_get_paymentlink($payment_id)?>?method=okwallet-personal",
                    data: { "okwallet-personal": "<?php echo $payment_id?>", "trxid": trxid, "number": number },
