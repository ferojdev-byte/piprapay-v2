<?php
$plugin_meta = [
    'Plugin Name'       => 'OkWallet Personal',
    'Description'       => 'Accept OkWallet Personal payments directly from customers. Perfect for freelancers and small businesses.',
    'Version'           => '1.0.0',
    'Author'            => 'PipraPay',
...
function okwallet_personal_admin_page() {
...
function okwallet_personal_checkout_page($payment_id) {
