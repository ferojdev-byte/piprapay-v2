<?php
$plugin_meta = [
    'Plugin Name'       => 'Nagad Merchant API',
    'Description'       => 'Accept Nagad Merchant API payments directly from customers. Perfect for freelancers and small businesses.',
    'Version'           => '1.0.0',
    'Author'            => 'PipraPay',
...
function nagad_merchant_api_admin_page() {
...
function nagad_merchant_api_checkout_page($payment_id) {
