<?php
    $plugin_slug = 'nagad-merchant-api';
        ...
        <div class="d-grid gap-3 gap-lg-5">
          ...
          <div class="card">
            ...
            <div class="card-body">
                <div class="row mb-4">
                  <div class="col-sm-6">
                    <label for="nagad_app_account" class="col-sm-12 col-form-label form-label">Nagad App Account</label>
                    <div class="input-group">
                        <input type="text" class="form-control" name="nagad_app_account" id="nagad_app_account" value="<?= htmlspecialchars($settings['nagad_app_account'] ?? '') ?>">
                    </div>
                    <div class="text-secondary mt-2"> </div>
                  </div>

                  <div class="col-sm-6">
                    <label for="nagad_merchant_id" class="col-sm-12 col-form-label form-label">Nagad Merchant ID</label>
                    <div class="input-group">
                        <input type="text" class="form-control" name="nagad_merchant_id" id="nagad_merchant_id" value="<?= htmlspecialchars($settings['nagad_merchant_id'] ?? '') ?>">
                    </div>
                    <div class="text-secondary mt-2"> </div>
                  </div>
                  
                  <div class="col-sm-6">
                    <label for="nagad_private_key" class="col-sm-12 col-form-label form-label">Nagad Private Key</label>
                    <div class="input-group">
                        <input type="text" class="form-control" name="nagad_private_key" id="nagad_private_key" value="<?= htmlspecialchars($settings['nagad_private_key'] ?? '') ?>">
                    </div>
                    <div class="text-secondary mt-2"> </div>
                  </div>
                  
                  <div class="col-sm-6">
                    <label for="nagad_public_key" class="col-sm-12 col-form-label form-label">Nagad Public Key</label>
                    <div class="input-group">
                        <input type="text" class="form-control" name="nagad_public_key" id="nagad_public_key" value="<?= htmlspecialchars($settings['nagad_public_key'] ?? '') ?>">
                    </div>
                    <div class="text-secondary mt-2"> </div>
                  </div>
                  
                  <div class="col-sm-6">
                    <label for="nagad_mode" class="col-sm-12 col-form-label form-label">Mode</label>
                    <div class="input-group">
                      <select class="form-control" name="nagad_mode" id="nagad_mode">
                        <?php $nagad_mode = isset($settings['nagad_mode']) ? strtolower($settings['nagad_mode']) : ''; ?>
                        <option value="sandbox" <?php echo ($nagad_mode === 'sandbox') ? 'selected' : ''; ?>>Sandbox</option>
                        <option value="live" <?php echo ($nagad_mode === 'live') ? 'selected' : ''; ?>>Live</option>
                      </select>
                    </div>
                    <div class="text-secondary mt-2"> </div>
                  </div>
