<?php
$plugin_meta = [
    'Plugin Name'       => 'Midland Bank PLC',
    'Description'       => 'Accept Midland Bank PLC payments directly from customers. Perfect for freelancers and small businesses.',
    'Version'           => '1.0.0',
    'Author'            => 'PipraPay',
...
function midland_bank_plc_admin_page() {
...
function midland_bank_plc_checkout_page($payment_id) {
