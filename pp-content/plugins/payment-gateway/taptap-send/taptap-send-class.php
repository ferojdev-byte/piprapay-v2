<?php
$plugin_meta = [
    'Plugin Name'       => 'Taptap Send',
    'Description'       => 'Accept Taptap Send payments directly from customers. Perfect for freelancers and small businesses.',
    'Version'           => '1.0.0',
    'Author'            => 'PipraPay',
...
function taptap_send_admin_page() {
...
function taptap_send_checkout_page($payment_id) {
